<template>
  ...
  >
    ...
    <div v-if="$store.getters['repair/category/partsCategory']">
      <div class="col-12 mt-20">
        <el-table
          :data="$store.getters['repair/category/partsCategory']"
          stripe
          size="mini"
        >
          <!-- name -->
...
export default {
  ...
  methods: {
    ...
    edit(data) {
      this.$store.dispatch('repair/category/setPart', data)
      this.$store.commit('settings/SWITCH_DRAWNER', {
