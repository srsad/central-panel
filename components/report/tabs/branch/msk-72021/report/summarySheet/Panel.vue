<template>
  <div class="row">
    <div class="col-md-10">
      <el-select
        v-if="$abilities('report-msk_72021_panel_summorysheat_panel-read')"
        v-model="report"
        size="mini"
...
<script>
import AppList from '~/components/report/tabs/branch/msk-72021/report/summarySheet/List'
...
export default {
  ...
  data() {
    return {
      ...
      report: '',
      tempBrands: {},
      branchId: '72021', // id филиала - из ремонлайн
